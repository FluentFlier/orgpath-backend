          ...
          <div className="bg-white rounded-2xl shadow-2xl overflow-hidden animate-in slide-in-from-bottom duration-700">
                ...
                <div className="flex-1 text-slate-900">
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-sm text-slate-500 animate-in slide-in-from-left duration-700 delay-200">({memberData.tenure}) • {memberData.department}</p>
                    </div>
            ...
            <div className="p-8">
              ...
              <div className="mb-8 space-y-6 bg-gradient-to-br from-[#106BB0]/5 to-[#06A119]/5 p-6 rounded-2xl border border-slate-200/60 shadow-sm">
                ...
                {memberData.assessments.map((assessment: any, idx: number) => (
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        <div className="space-y-3">
                          ...
                          <div className="h-2.5 w-full bg-slate-200 rounded-full overflow-hidden">
                            <div className="h-full bg-[#06A119] rounded-full transition-all duration-1000" style={{ width: `${assessment.leadership}%` }} />
                          </div>
                        </div>
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="h-2.5 w-full bg-slate-200 rounded-full overflow-hidden">
                            <div className="h-full bg-[#06A119] rounded-full transition-all duration-1000" style={{ width: `${assessment.communication}%` }} />
                          </div>
                        </div>
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="h-2.5 w-full bg-slate-200 rounded-full overflow-hidden">
                            <div className="h-full bg-[#06A119] rounded-full transition-all duration-1000" style={{ width: `${assessment.adaptability}%` }} />
                          </div>
                        </div>
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="h-2.5 w-full bg-slate-200 rounded-full overflow-hidden">
                            <div className="h-full bg-[#06A119] rounded-full transition-all duration-1000" style={{ width: `${assessment.collaboration}%` }} />
                          </div>
                        </div>
                      </div>
                    </CardContent>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-6">
                  ...
                  <Card className="border-2 border-gray-200 hover:border-[#06A119] hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] animate-in slide-in-from-left duration-700 delay-500 group">
                    ...
                    <CardContent>
                      {memberData.rolesInLineFor.map((role: any, idx: number) => (
                        <div 
                          key={idx} 
                  ...
                  {showSuccessionModal && (
                    <SuccessionPlanModal 
                      ...
                      roleTitle={memberData.rolesInLineFor[0]?.title || "Manager"}
                    />
                  )}
                  ...
                  <Card className="border-2 border-gray-200 hover:border-[#1B8784] hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] animate-in slide-in-from-left duration-700 delay-600 group">
                    ...
                    <CardContent className="space-y-4">
                      <div className="space-y-3">
                        {memberData.feedback.map((item: any, idx: number) => (
                      ...
                      <div className="bg-gradient-to-br from-gray-50 to-white rounded-xl p-5 border border-gray-200 hover:border-[#1B8784] hover:shadow-lg transition-all duration-300 hover:scale-[1.01]">
                        <h3 className="font-bold text-gray-900 mb-2 flex items-center gap-2">
                          <Award className="w-5 h-5 text-[#1B8784]" /> Feedback Summary
                        </h3>
                ...
                <div className="space-y-6">
                  ...
                  <Card className="border-2 border-gray-200 hover:border-[#1B8784] hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] animate-in slide-in-from-right duration-700 delay-500 group">
                    ...
                    <CardContent className="space-y-2">
                      {memberData.internalExperience.map((exp: any, idx: number) => (
                    ...
                    <CardContent>
                      <div className="flex items-start justify-between gap-6">
                        <div className="flex-1 grid grid-cols-1 gap-3">
                          {memberData.topCapabilities.map((capability: string, idx: number) => (
                            <div 
                              key={idx} 
